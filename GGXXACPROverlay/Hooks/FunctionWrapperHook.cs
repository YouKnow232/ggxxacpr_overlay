...
{
    internal unsafe class FunctionWrapperHook : GenericPatchHook
    {
        public FunctionWrapperHook(nint callInstructionAddress, nint hookAddress)
            : base(BitConverter.GetBytes(hookAddress), callInstructionAddress + 1)
        { }
